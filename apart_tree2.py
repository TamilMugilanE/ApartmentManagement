...
# Specify the desired folder and file name
...
A_Block_1 = House("A1", A_Block) #Temporarily keep this as the name
A_Block_2 = House("A2", A_Block) #Temporarily keep this as the name
